...
STEPS:
 ...
 3. Create a Cliniko trial account and derive the API Key and Secret.
 ...
 4. Update the Cliniko properties file at location "<CLINIKO_CONNECTOR_HOME>/cliniko-connector/cliniko-connector-1.0.0/org.wso2.carbon.connector/src/test/resources/artifacts/ESB/connector/config" as below.
 ...
 5. Make sure that cliniko is specified as a module in ESB Connector parent pom.xml.
